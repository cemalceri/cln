  ...
  var AppCalendar = function (_Site) {
    ...
    babelHelpers.createClass(AppCalendar, [{
      ...
      value: function handleFullcalendar() {
        var rezervations = document.getElementById("calendarJsFile").getAttribute("data");
        // // debugger;
        // rezervations=rezervations.replaceAll("'","");
        // rezervations= '{"title": "All Day Event", "start": "2016-10-01"}, {"title": "Event2", "start": "2016-10-02"}'
        // $.each(rezervations,function (title, start) {
        //   debugger;
        //   alert(item.title)
        // });
        var myEvents = [{
