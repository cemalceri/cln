...
urlpatterns = [
    ...
    path("uye/pasife-cevir/<int:id>", uye_views.pasife_cevir, name="pasife_cevir_uye"),
    path("uye/aktife-cevir/<int:id>", uye_views.aktife_cevir, name="aktife_cevir_uye"),
    ...
    path("muhasebe/hesapla-uye-borcu/<int:uye_id>", mv.hesapla_uye_borcu, name="hesapla_uye_borcu"),
    path("muhasebe/hesapla-tum-uyelerin-borcu", mv.hesapla_tum_uyelerin_borcu, name="hesapla_tum_uyelerin_borcu"),
